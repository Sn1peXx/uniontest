...
<head>
    ...
    <link rel="stylesheet" href="../profile-add/info.css">
...
<div class="container" style="margin-top: 10px;">
    ...
    <section>
        <div class="container">
            <form action="./check-setting/check-profile.php" method="POST" class="form">
                <div class="row">
                    <?php 
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="my_name" value="<?php echo $vouchers['myName']?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Страна</label>
                            <input type="text" class="form-control" name="country" value="<?php echo mb_convert_encoding($vouchers['country'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Фотография профиля</label>
                            <input class="form-control" type="file" id="formFile" value="<?php echo mb_convert_encoding($vouchers['img'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ссылка на ВКонтакте</label>
                            <input type="text" class="form-control" name="vk" value="<?php echo mb_convert_encoding($vouchers['vk'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ссылка на  Instagram</label>
                            <input type="text" class="form-control" name="inst" value="<?php echo mb_convert_encoding($vouchers['inst'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ссылка на Telegram</label>
                            <input type="text" class="form-control" name="telegram" value="<?php echo mb_convert_encoding($vouchers['tg'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Ссылка на YouTube</label>
                            <input type="text" class="form-control" name="yt" value="<?php echo mb_convert_encoding($vouchers['yt'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
