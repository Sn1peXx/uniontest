...
<?php if ($_SESSION['email'] == "") : ?>
    ...
    <?php
        ...
        if ($mysql->connect_error) {
            ...
            $x = $_SESSION['email'];
            $result = $mysql->query("SELECT * FROM `contactDetails` WHERE `email` = '$x'");
    ?>
            ...
            <div class="row">
                <div class="col-10">
                    <div class="my__profile">
                        <h1 class="profile__title">Контактные детали</h1>
                        ...
                        ?>
                            ...
                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">ФИО</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['fullName'] ? $vouchers['fullName'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Логин</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['login'] ? $vouchers['login'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Адрес</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['adress'] ? $vouchers['adress'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Адрес доставки</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['adressDelivery'] ? $vouchers['adressDelivery'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Вид проживания</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['typeOfResidence'] ? $vouchers['typeOfResidence'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Телефон дневной</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['telephoneDay'] ? $vouchers['telephoneDay'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Телефон вечерний</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['telephoneNight'] ? $vouchers['telephoneNight'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Телефон дополнительный</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['telephoneAdd'] ? $vouchers['telephoneAdd'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>
<!-- 
                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Электронная почта для сброса пароля</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"></div>
                                </div>
                            </div> -->
                            
                            <div class="change">
                                <a class="change__text" href="./answers-contact.php">Редактировать</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <img src="../../assets/img/license/CV9bG9VWsAQ9epE.jpg" width="220px" height="290px" alt=""
                        class="add">
                </div>
            </div>
        </div>
