...
<body> 
    ...
    <section>
        <div class="container">
            <form action="./profile-check/check-answer.php" method="POST" class="form">
                <div class="row">
                        <?php 
                    ...
                    <div class="col-4">
                        <div class="mb-3"> 
                            ...
                            <input type="text" class="form-control" name="name" value="<?php echo mb_convert_encoding($vouchers['fullName'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Логин</label>
                            <input type="text" class="form-control" name="login" value="<?php echo mb_convert_encoding($vouchers['login'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Адрес</label>
                            <input type="text" class="form-control" name="address" value="<?php echo mb_convert_encoding($vouchers['adress'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Адрес доставки</label>
                            <input type="text" class="form-control" name="address__deliver" value="<?php echo mb_convert_encoding($vouchers['adressDelivery'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Вид проживания</label>
                            <input type="text" class="form-control" name="live__style" value="<?php echo mb_convert_encoding($vouchers['typeOfResidence'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Телефон дневной</label>
                            <input type="text" class="form-control" name="phone" value="<?php echo mb_convert_encoding($vouchers['telephoneDay'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Телефон вечерний</label>
                            <input type="text" class="form-control" name="phoneN" value="<?php echo mb_convert_encoding($vouchers['telephoneNight'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Телефон дополнительный</label>
                            <input type="text" class="form-control" name="phoneS" value="<?php echo mb_convert_encoding($vouchers['telephoneAdd'], 'UTF-8', 'UTF-8')?>">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="save__btn">
    ...
    <script src="../../../js/modules/phone-mask.js"></script>
