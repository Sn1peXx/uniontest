...
<head>
    ...
    <?php session_start() ?>
    <title>Ваша личность, потребности и жизненные обстоятельства</title>
</head>
            ...
            <div class="row">
                <div class="col-10">
                    <div class="my__profile">
                        <h1 class="profile__title">Ваша личность, потребности и жизненные обстоятельства</h1>
                        <div class="profile__main">
                            ...
                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Семейное положение</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['family'] ? $vouchers['family'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Инвалидность</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['invalid'] ? $vouchers['invalid'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Страна юридического гражданства</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['legal'] ? $vouchers['legal'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Этническая принадлежность</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['ethnicity'] ? $vouchers['ethnicity'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Религия или вера</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['religion'] ? $vouchers['religion'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row gray">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Сексуальная ориентация</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['sexorientation'] ? $vouchers['sexorientation'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            <div class="profile__item row ">
                                <div class="personal__question col-4">
                                    <div class="personal__text">Соответствует ли ваш гендер гендеру, данному при рождении?</div>
                                </div>
                                <div class="personal__answer col-8">
                                    <div class="personal__answ"><?php echo $vouchers['borngender'] ? $vouchers['borngender'] : "Пожалуйста, заполните" ?></div>
                                </div>
                            </div>

                            
                            <div class="change" style="margin-top: 20px;">
                                <a class="change__text" href="./answer-personality.php">Редактировать</a>
                            </div>
                        </div>
                    </div>
                </div>
